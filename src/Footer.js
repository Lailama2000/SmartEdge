...
export default function Footer() {
  ...
  return (
   ...
   <img src={logo} style={{height:'30px'}}/>
              ...
              <Link   href='https://smartedge.me'
              style={{color:'white' ,fontSize:'14px', textDecoration: 'none', borderBottom: '1px solid white' }} >Privacy Policy</Link>
              </Typography>
              <Typography sx={{color:'white ' ,fontSize:'14px'}}>Powered By {" "}
                <Link href='https://smartedge.me' style={{color:'white' ,fontSize:'14px', textDecoration: 'none',fontWeight:'bold'}} >SmartEdge</Link>
              </Typography>
      </Stack>
      </Box>
      </div>
