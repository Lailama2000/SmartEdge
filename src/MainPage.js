...
export default function MainPage() {
  ...
  return (
    <>
    <img style={{position:'fixed',top:'85%',right:matches?'50px':'10px',width:matches?'40px':'30px',cursor:'pointer'}} src={WhatsAppimage}/>
    ...
    <Button sx={{bgcolor:'white',color:'#0854C1',borderRadius:'0px 20px 20px 20px',padding:'15px',width:'160px',fontWeight:'bold'
  ,'&:hover':{bgcolor:'#FECD2B',transition:'0.2s ease-in'}}}>
      Get A Quote!
    </Button>
    </Typography>
    </div>
    <div style={{ background: 'linear-gradient(#001D46, #383737)' }}>
